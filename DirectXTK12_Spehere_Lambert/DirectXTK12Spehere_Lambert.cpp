...
HRESULT DirectXTK12Spehere_Lambert::CreateBuffer(DirectX::GraphicsMemory* graphicsMemory, DX::DeviceResources* deviceResources, int height, int width)
{
...
//(DIrectXTK12Assimpで追加)
void  DirectXTK12Spehere_Lambert::Draw(const DX::DeviceResources* DR) {
...
Microsoft::WRL::ComPtr<ID3D12PipelineState>  DirectXTK12Spehere_Lambert::CreateGraphicsPipelineState(
